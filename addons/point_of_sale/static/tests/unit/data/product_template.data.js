...
export class ProductTemplate extends models.ServerModel {
    ...
    _records = [
        ...
        },
        {
            ...
            pos_sequence: 5,
            available_in_pos: true,
            attribute_line_ids: [3, 4],
            active: true,
            image_128: false,
            product_variant_ids: [51, 52],
            public_description: false,
            pos_optional_product_ids: [],
            sequence: 1,
            product_tag_ids: [],
        },
        {
            ...
            pos_sequence: 5,
            available_in_pos: false,
            attribute_line_ids: [5, 6],
            active: true,
            image_128: false,
            combo_ids: [],
            product_variant_ids: [60, 61],
            public_description: false,
            pos_optional_product_ids: [],
            sequence: 1,
            product_tag_ids: [],
