...
class MicrosoftOutlookMixin(models.AbstractModel):
    ...
    def _compute_is_microsoft_outlook_configured(self):
        # <START_OF_CHANGE>
        microsoft_outlook_client_id = self.env.user.company_id.microsoft_outlook_client_identifier
        microsoft_outlook_client_secret = self.env.user.company_id.microsoft_outlook_client_secret
        # <END_OF_CHANGE>
