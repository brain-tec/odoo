...
wTourUtils.clickOnSnippet({
    ...
    trigger: columnsSnippetRow + ":has(.col-lg-2:nth-child(5):not(.col-2))" +
            ":not(:has(:nth-child(6)))",
    isCheck: true,
}, {
...
// next step approximates part of what could be reached.
{
    ...
    run: ({ tip_widget }) => {
        const secondItem = tip_widget.$anchor[0];
        secondItem.classList.replace("col-4", "col-6");
        // As this is a hardcoded class replacement, a click is needed to
        // update the column count.
        secondItem.previousElementSibling.click();
    },
}, {
    ...
    trigger: "iframe .o_overlay_move_options:not('d-none') [data-name='move_right_opt']",
}, {
    ...
    content: "Click on the 4th item",
    trigger: columnsSnippetRow + " > :nth-child(4)",
}, {
    content: "Change the orders of the 4th and 5th items",
    trigger: "iframe .o_overlay_move_options:not('d-none') [data-name='move_right_opt']",
}, {
